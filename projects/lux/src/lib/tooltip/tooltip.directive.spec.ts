...
describe('TooltipDirective', () => {
    ...
    it('it should be created component with tooltip declarative', () => {
        const spectator = createDirective('<button luxTooltip>Button with Tooltip</button>');
        expect(spectator.directive).toBeTruthy();
    });

    it('it should display no tooltip (label not defined)', () => {
        const spectator = createDirective('<button luxTooltip>Button Default</button>');
    ...
    it('it should display default tooltip with top placement like default value', () => {
        const spectator = createDirective('<button luxTooltip content="A">Button Default</button>');
        const button = spectator.query('button');
    ...
    it('it should display tooltip with string content', () => {
        const spectator = createDirective('<button luxTooltip content="Custom Tooltip">Button String</button>');
        const button = spectator.query('button');
    ...
    it('it should display tooltip in the left', () => {
        ...
        const spectator = createDirective(`<button luxTooltip content="${content}" placement="${placement.toLowerCase()}">
