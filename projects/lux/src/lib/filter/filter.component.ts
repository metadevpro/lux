import { Component, Input, Output, EventEmitter, OnDestroy, OnInit, forwardRef } from '@angular/core';
...
export class FilterComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.inputId = this.inputId ? this.inputId : `filter$${FilterComponent.idCounter++}`;
  }
